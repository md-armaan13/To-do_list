...
if (document.cookie.length > 0) {
  ...
  if (c_start != -1) {
      ...
      cookie = document.cookie.substring(c_start, c_end);
      console.log(typeof(cookie));
      if(!document.cookie.substring(c_start, c_end)){
 ...
 const alllist = async ()=>{
  ...
  await fetch(url, {
    ...
    .then((data) => {
      ...
      // code here //
      if (data.error) {
        alert("Something Went Wrong"); /*displays error message*/
      } else {
        console.log(listitem);
        for(j of listitem.list){
          console.log(j.description);
          let textEnterd =j.description
            ...
            function () {
              ...
              console.log(del);
                  ...
                  .then((data) => {
                    ...
                    // code here //
                    if (data.error) {
                      alert("Error in creating task"); /*displays error message*/
                    } else {
              ...
              if (liElement.classList != "font") {
                ...
                console.log(del);
                    ...
                    .then((data) => {
                      ...
                      // code here //
                      if (data.error) {
                        alert("Error in processing task"); /*displays error message*/
                      } else {
...
function addItem() {
  ...
  if (textEnterd.length < 1) {
    ...
    liElement.innerHTML = `
      <div class="main-container">
        <span id = "message">${textEnterd}</span>
        <div class="btn-group">
          <button class="done">✔</button>
          <button class="delete">✖</button>
          <button class="edit">✏️</button>
      ...
      function () {
        ...
        if (liElement.classList != "font") {
          ...
          if (spanElement.getAttribute("contenteditable") == "true") {
            ...
            console.log("second",spanText)
          } else {
            spanElement.setAttribute("contenteditable", true);
          }
          
        }
        let message = liElement.querySelector("#message").innerHTML;
